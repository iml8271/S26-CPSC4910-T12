...
DELIMITER $$
DROP TRIGGER IF EXISTS trg_user_creation_date;
...
DELIMITER $$
DROP TRIGGER IF EXISTS trg_password_update;
...
DELIMITER $$
DROP TRIGGER IF EXISTS after_driver_profile_insert;
...
DELIMITER $$
DROP TRIGGER IF EXISTS after_application_accepted;
